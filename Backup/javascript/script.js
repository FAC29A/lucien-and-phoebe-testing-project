    ...
    function addTodoItem(text) {
        ...
        listItem.innerHTML = `
            ...
            <textarea class="todo-text"  disabled>${text}</textarea>
        `;

        const todoTextarea= listItem.querySelector('.todo-text')

        // todoTextarea.style.height = "auto"; 
        // todoTextarea.style.height = todoTextarea.scrollHeight + 'px'; 
        ...
        // Add the event listener to adjust the height when the content changes
